...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2016 at 06:04 PM
...
`id` int(10) NOT NULL,
  ...
  `interest_rate_max` varchar(50) DEFAULT NULL,
  `interest_rate_average` varchar(50) DEFAULT NULL,
  `downpayment_purchase_appartment` varchar(10) DEFAULT NULL,
