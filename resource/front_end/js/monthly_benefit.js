...
$(function(event) {
		...
		$('.inputWrapper input').blur(function(){
			...
			if(finAsst < 50000 && finAsst < amtDetail){
				alert("Minimum amount should be 50000 & maximum amount 10000000");
				$("#finalAssest").val("50000");
				$(this).parents('.slideWrapper').find('.draggable, .highLight ').css('left',0);
				$(this).parents('.slideWrapper').find('ul').animate({marginLeft:'0px'});
			}
			else if(finAsst >=50000 && finAsst <=amtDetail)
			{
			...
			else if(finAsst <0 || finAsst >=amtDetail )
			{
				...
				alert("Minimum amount should be 50000 & Maximum amount should be 10000000");
				$("#finalAssest").val("50000");
				$(this).parents('.slideWrapper').find('.draggable, .highLight ').css('left',0);
				/*$(this).val(amtDetail);
