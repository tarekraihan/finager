...
if(D.css("box-sizing")==="border-box"){aH=0;
f=0
}else{aH=D.css("paddingTop")+" "+D.css("paddingRight")+" "+D.css("paddingBottom")+" "+D.css("paddingLeft");
f=(parseInt(D.css("paddingLeft"),10)||0)+(parseInt(D.css("paddingRight"),10)||0)
}function ar(aQ){var aL,aN,aM,aJ,aI,aP,aO=false,aK=false;
ay=aQ;
if(Y===c){aI=D.scrollTop();
aP=D.scrollLeft();
...
if(aJ){aj=D.innerWidth()+f;
v=D.innerHeight();
al.css({width:aj+"px",height:v+"px"})
}if(!aJ&&L==T&&Y.outerHeight()==Z){D.width(aj);
return
}L=T;
Y.css("width","");
D.width(aj);
...
az=q>1;
aE=y>1;
if(!(aE||az)){D.removeClass("jspScrollable");
...
z();
F();
if(aL){N(aK?(T-aj):aN,false);
M(aO?(Z-v):aM,false)
}J();
ag();
an();
if(ay.enableKeyboardNavigation){S()
}if(ay.clickOnTrack){p()
}C();
if(ay.hijackInternalLinks){m()
}}if(ay.autoReinitialise&&!av){av=setInterval(function(){ar(ay)
...
ap=U.find(">.jspTrack");
au=ap.find(">.jspDrag");
if(ay.showArrows){aq=b('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp",aD(0,-1)).bind("click.jsp",aB);
af=b('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp",aD(0,1)).bind("click.jsp",aB);
if(ay.arrowScrollOnHover){aq.bind("mouseover.jsp",aD(0,-1,aq));
af.bind("mouseover.jsp",aD(0,1,af))
}ak(ap,ay.verticalArrowPositions,aq,af)
}t=v;
al.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function(){t-=b(this).outerHeight()
});
...
G.width(l+"px");
aa=0
}function F(){if(aE&&az){var aI=G.outerHeight(),s=ap.outerWidth();
t-=aI;
b(am).find(">.jspCap:visible,>.jspArrow").each(function(){l+=b(this).outerWidth()
});
l-=s;
v-=s;
aj-=aI;
...
j=l-at;
ae(aa)
}if(az){A=Math.ceil(1/q*t);
if(A>ay.verticalDragMaxHeight){A=ay.verticalDragMaxHeight
}else{if(A<ay.verticalDragMinHeight){A=ay.verticalDragMinHeight
}}au.height(A+"px");
i=t-A;
ad(I)
}}function ak(aJ,aL,aI,s){var aN="before",aK="after",aM;
...
}function aD(aI,s,aJ){return function(){H(aI,s,this,aJ);
this.blur();
return false
}
}function H(aL,aK,aO,aN){aO=b(aO).addClass("jspActive");
var aM,aJ,aI=true,s=function(){if(aL!==0){Q.scrollByX(aL*ay.arrowButtonSpeed)
...
if(aM<0){if(I-aQ>aS){Q.scrollByY(-aP)
}else{V(aS)
}}else{if(aM>0){if(I+aQ<aS){Q.scrollByY(aP)
}else{V(aS)
}}else{aK();
return
...
if(aM<0){if(aa-aQ>aS){Q.scrollByX(-aP)
}else{W(aS)
}}else{if(aM>0){if(aa+aQ<aS){Q.scrollByX(aP)
}else{W(aS)
}}else{aK();
return
}}aJ=setTimeout(s,aI?ay.initialDelay:ay.trackClickRepeatFreq);
...
}function u(aI,s){if(ay.showArrows){aq[aI?"addClass":"removeClass"]("jspDisabled");
af[s?"addClass":"removeClass"]("jspDisabled")
}}function r(aI,s){if(ay.showArrows){ax[aI?"addClass":"removeClass"]("jspDisabled");
x[s?"addClass":"removeClass"]("jspDisabled")
}}function M(s,aI){var aJ=s/(Z-v);
V(aJ*i,aI)
}function N(aI,s){var aJ=aI/(T-aj);
W(aJ*j,s)
...
aO=aI+v;
if(s<aI||aQ){aR=s-ay.horizontalGutter
}else{if(s+aK>aO){aR=s-v+aK+ay.horizontalGutter
}}if(!isNaN(aR)){M(aR,aJ)
}aP=aC();
aS=aP+aj;
if(aU<aP||aQ){aT=aU-ay.horizontalGutter
}else{if(aU+aL>aS){aT=aU-aj+aL+ay.horizontalGutter
}}if(!isNaN(aT)){N(aT,aJ)
}}function aC(){return -Y.position().left
}function aA(){return -Y.position().top
}function K(){var s=Z-v;
return(s>20)&&(s-aA()<10)
}function B(){var s=T-aj;
return(s>20)&&(s-aC()<10)
...
if(ay.hideFocus){D.css("outline","none");
if("hideFocus" in al[0]){D.attr("hideFocus",true)
}}else{D.css("outline","");
if("hideFocus" in al[0]){D.attr("hideFocus",false)
}}function aJ(){var aM=aa,aL=I;
switch(s){case 40:Q.scrollByY(ay.keyboardSpeed,false);
break;
...
try{aK=b("#"+aJ+', a[name="'+aJ+'"]')
}catch(s){return
}if(aK.length&&Y.find(aJ)){if(al.scrollTop()===0){aI=setInterval(function(){if(al.scrollTop()>0){ab(aK,true);
...
aP;
try{aP=b("#"+aO+', a[name="'+aO+'"]')
}catch(aQ){return
}if(!aP.length){return
}aJ=aP.closest(".jspScrollable");
aM=aJ.data("jsp");
aM.scrollToElement(aP,true);
if(aJ[0].scrollIntoView){aL=b(a).scrollTop();
aN=aP.offset().top;
if(aN<aL||aN>aL+b(a).height()){aJ[0].scrollIntoView()
}}s.preventDefault()
})
}function an(){var aJ,aI,aL,aK,aM,s=false;
al.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",function(aN){var aO=aN.originalEvent.touches[0];
aJ=aC();
aI=aA();
aL=aO.pageX;
aK=aO.pageY;
...
},scrollTo:function(aJ,s,aI){N(aJ,aI);
M(s,aI)
},scrollToX:function(aI,s){N(aI,s)
},scrollToY:function(s,aI){M(s,aI)
},scrollToPercentX:function(aI,s){N(aI*(T-aj),s)
},scrollToPercentY:function(aI,s){M(aI*(Z-v),s)
},scrollBy:function(aI,s,aJ){Q.scrollByX(aI,aJ);
Q.scrollByY(s,aJ)
},scrollByX:function(s,aJ){var aI=aC()+Math[s<0?"floor":"ceil"](s),aK=aI/(T-aj);
W(aK*j,aJ)
},scrollByY:function(s,aJ){var aI=aA()+Math[s<0?"floor":"ceil"](s),aK=aI/(Z-v);
V(aK*i,aJ)
...
},getPercentScrolledX:function(){return aC()/(T-aj)
},getPercentScrolledY:function(){return aA()/(Z-v)
...
var f=true;
if(!(window.history&&history.pushState)){$(".history-message").fadeIn()
}var b=$("#popstateLog");
$(window).on("popstate",function(g){d(g)
});
var d=function(i){var h=new Date(i.originalEvent.timeStamp).toLocaleTimeString();
...
$("#example1-push-state").on("click",function(){var h="A new title!";
var g="?"+$("#new-url").text()||"hello";
history.pushState(null,h,g)
});
$("#example2-replace-state").on("click",function(){var h="A new title!";
var g="?"+$("#new-url-replacestate").text()||"replaced!";
history.replaceState(null,h,g)
});
var a=function(g){$.ajax({headers:{"X-Content-Only":"true"},type:"GET",url:g,cache:false}).done(function(h){$("#ajaxOutput").remove();
var i=$('<div id="ajaxOutput"></div>').html($("#ajaxOutput",h).html()).addClass("prdWrapper animated bounceInLeft");
$("#example-4").append(i)
})
};
var e=function(h){var g=document.location.search.split("=")[1];
if(g&&g.length>0){$("#twitter-user").text(g);
requestTweet(g)
}if((document.location.pathname!==c&&document.location.pathname!==c+"/")&&!h){a(document.location.pathname)
}else{if(!h){console.log("hmm what to do");
 ...
 */
(function(){function a(b){return b.replace(/<.[^<>]*?>/g," ").replace(/&nbsp;|&#160;/gi," ").replace(/[.(),;:!?%#$'"_+=\/\-]*/g,"")
}jQuery.validator.addMethod("maxWords",function(c,b,d){return this.optional(b)||a(c).match(/\b\w+\b/g).length<=d
},jQuery.validator.format("Please enter {0} words or less."));
jQuery.validator.addMethod("minWords",function(c,b,d){return this.optional(b)||a(c).match(/\b\w+\b/g).length>=d
},jQuery.validator.format("Please enter at least {0} words."));
jQuery.validator.addMethod("rangeWords",function(e,b,f){var d=a(e);
var c=/\b\w+\b/g;
...
jQuery.validator.addMethod("zipcodeUS",function(b,a){return this.optional(a)||/\d{5}-\d{4}$|^\d{5}$/.test(b)
},"The specified US ZIP Code is invalid");
jQuery.validator.addMethod("integer",function(b,a){return this.optional(a)||/^-?\d+$/.test(b)
},"A positive or negative non-decimal number please");
jQuery.validator.addMethod("vinUS",function(o){if(o.length!==17){return false
}var h,a,l,j,b,k;
...
a<c.length;
a++){if(l.toUpperCase()===c[a]){l=m[a];
l*=j;
if(isNaN(k)&&a===8){k=c[a]
}break
}}}e+=l
}b=e%11;
if(b===10){b="X"
...
jQuery.validator.addMethod("dateITA",function(e,c){var a=false;
...
jQuery.validator.addMethod("iban",function(q,j){if(this.optional(j)){return true
}if(!(/^([a-zA-Z0-9]{4} ){2,8}[a-zA-Z0-9]{1,4}|[a-zA-Z0-9]{12,34}$/.test(q))){return false
...
var m=a[c];
if(typeof m!=="undefined"){var k=new RegExp("^[A-Z]{2}\\d{2}"+m+"$","");
...
h++){d=e.charAt(h);
if(d!=="0"){l=false
}if(!l){f+="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(d)
}}var r="";
var o="";
for(var b=0;
b<f.length;
...
jQuery.validator.addMethod("dateNL",function(b,a){return this.optional(a)||/^(0?[1-9]|[12]\d|3[01])[\.\/\-](0?[1-9]|1[012])[\.\/\-]([12]\d)?(\d\d)$/.test(b)
},"Please enter a correct date");
jQuery.validator.addMethod("phoneNL",function(b,a){return this.optional(a)||/^((\+|00(\s|\s?\-\s?)?)31(\s|\s?\-\s?)?(\(0\)[\-\s]?)?|0)[1-9]((\s|\s?\-\s?)?[0-9]){8}$/.test(b)
},"Please specify a valid phone number.");
jQuery.validator.addMethod("mobileNL",function(b,a){return this.optional(a)||/^((\+|00(\s|\s?\-\s?)?)31(\s|\s?\-\s?)?(\(0\)[\-\s]?)?|0)6((\s|\s?\-\s?)?[0-9]){8}$/.test(b)
},"Please specify a valid mobile number");
jQuery.validator.addMethod("postalcodeNL",function(b,a){return this.optional(a)||/^[1-9][0-9]{3}\s?[a-zA-Z]{2}$/.test(b)
},"Please specify a valid postal code");
jQuery.validator.addMethod("bankaccountNL",function(f,c){if(this.optional(c)){return true
}if(!(/^[0-9]{9}|([0-9]{2} ){3}[0-9]{3}$/.test(f))){return false
}var e=f.replace(/ /g,"");
var d=0;
var a=e.length;
for(var h=0;
...
jQuery.validator.addMethod("bankorgiroaccountNL",function(b,a){return this.optional(a)||($.validator.methods.bankaccountNL.call(this,b,a))||($.validator.methods.giroaccountNL.call(this,b,a))
},"Please specify a valid bank or giro account number");
jQuery.validator.addMethod("time",function(b,a){return this.optional(a)||/^([01]\d|2[0-3])(:[0-5]\d){1,2}$/.test(b)
},"Please enter a valid time, between 00:00 and 23:59");
jQuery.validator.addMethod("time12h",function(b,a){return this.optional(a)||/^((0?[1-9]|1[012])(:[0-5]\d){1,2}(\ ?[AP]M))$/i.test(b)
...
jQuery.validator.addMethod("phoneUK",function(a,b){a=a.replace(/\(|\)|\s+|-/g,"");
return this.optional(b)||a.length>9&&a.match(/^(?:(?:(?:00\s?|\+)44\s?)|(?:\(?0))(?:\d{2}\)?\s?\d{4}\s?\d{4}|\d{3}\)?\s?\d{3}\s?\d{3,4}|\d{4}\)?\s?(?:\d{5}|\d{3}\s?\d{3})|\d{5}\)?\s?\d{4,5})$/)
},"Please specify a valid phone number");
jQuery.validator.addMethod("mobileUK",function(a,b){a=a.replace(/\(|\)|\s+|-/g,"");
return this.optional(b)||a.length>9&&a.match(/^(?:(?:(?:00\s?|\+)44\s?|0)7(?:[45789]\d{2}|624)\s?\d{3}\s?\d{3})$/)
},"Please specify a valid mobile number");
jQuery.validator.addMethod("phonesUK",function(a,b){a=a.replace(/\(|\)|\s+|-/g,"");
return this.optional(b)||a.length>9&&a.match(/^(?:(?:(?:00\s?|\+)44\s?|0)(?:1\d{8,9}|[23]\d{9}|7(?:[45789]\d{8}|624\d{6})))$/)
},"Please specify a valid uk phone number");
jQuery.validator.addMethod("postcodeUK",function(b,a){return this.optional(a)||/^((([A-PR-UWYZ][0-9])|([A-PR-UWYZ][0-9][0-9])|([A-PR-UWYZ][A-HK-Y][0-9])|([A-PR-UWYZ][A-HK-Y][0-9][0-9])|([A-PR-UWYZ][0-9][A-HJKSTUW])|([A-PR-UWYZ][A-HK-Y][0-9][ABEHMNPRVWXY]))\s?([0-9][ABD-HJLNP-UW-Z]{2})|(GIR)\s?(0AA))$/i.test(b)
...
jQuery.validator.addMethod("creditcardtypes",function(b,a,c){if(/[^0-9\-]+/.test(b)){return false
}b=b.replace(/\D/g,"");
var d=0;
if(c.mastercard){d|=1
}if(c.visa){d|=2
...
}if(c.all){d=1|2|4|8|16|32|64|128
}if(d&1&&/^(5[12345])/.test(b)){return b.length===16
}if(d&2&&/^(4)/.test(b)){return b.length===16
}if(d&4&&/^(3[47])/.test(b)){return b.length===15
}if(d&8&&/^(3(0[012345]|[68]))/.test(b)){return b.length===14
}if(d&16&&/^(2(014|149))/.test(b)){return b.length===15
}if(d&32&&/^(6011)/.test(b)){return b.length===16
}if(d&64&&/^(3)/.test(b)){return b.length===16
}if(d&64&&/^(2131|1800)/.test(b)){return b.length===15
}if(d&128){return true
}return false
},"Please enter a valid credit card number.");
jQuery.validator.addMethod("ipv4",function(b,a,c){return this.optional(a)||/^(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)$/i.test(b)
},"Please enter a valid IP v4 address.");
jQuery.validator.addMethod("ipv6",function(b,a,c){return this.optional(a)||/^((([0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}:[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){5}:([0-9A-Fa-f]{1,4}:)?[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){4}:([0-9A-Fa-f]{1,4}:){0,2}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){3}:([0-9A-Fa-f]{1,4}:){0,3}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){2}:([0-9A-Fa-f]{1,4}:){0,4}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){6}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(([0-9A-Fa-f]{1,4}:){0,5}:((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|(::([0-9A-Fa-f]{1,4}:){0,5}((\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b)\.){3}(\b((25[0-5])|(1\d{2})|(2[0-4]\d)|(\d{1,2}))\b))|([0-9A-Fa-f]{1,4}::([0-9A-Fa-f]{1,4}:){0,5}[0-9A-Fa-f]{1,4})|(::([0-9A-Fa-f]{1,4}:){0,6}[0-9A-Fa-f]{1,4})|(([0-9A-Fa-f]{1,4}:){1,7}:))$/i.test(b)
},"Please enter a valid IP v6 address.");
jQuery.validator.addMethod("pattern",function(b,a,c){if(this.optional(a)){return true
}if(typeof c==="string"){c=new RegExp("^(?:"+c+")$")
}return c.test(b)
},"Invalid format.");
jQuery.validator.addMethod("require_from_group",function(g,f,d){var e=this;
var b=d[1];
var c=$(b,f.form).filter(function(){return e.elementValue(this)
}).length>=d[0];
if(!$(f).data("being_validated")){var a=$(b,f.form);
a.data("being_validated",true);
a.valid();
a.data("being_validated",false)
}return c
},jQuery.format("Please fill at least {0} of these fields."));
jQuery.validator.addMethod("skip_or_fill_minimum",function(h,e,i){var b=this,c=i[0],d=i[1];
var g=$(d,e.form).filter(function(){return b.elementValue(this)
}).length;
var a=g>=c||g===0;
if(!$(e).data("being_validated")){var f=$(d,e.form);
...
if(d){return d
}if($(c).attr("type")==="file"){f=f.replace(/\*/g,".*");
if(c.files&&c.files.length){for(b=0;
b<c.files.length;
b++){a=c.files[b];
if(!a.type.match(new RegExp(".?("+f+")$","i"))){return false
}}}}return true
},jQuery.format("Please enter a value with a valid mimetype."));
jQuery.validator.addMethod("extension",function(b,a,c){c=typeof c==="string"?c.replace(/,/g,"|"):"png|jpe?g|gif";
return this.optional(a)||b.match(new RegExp(".("+c+")$","i"))
},jQuery.format("Please enter a value with a valid extension."));
function splitWrapedParsys(a){$("."+a).after('<div class="clear"></div>')
}(function(a){a.extend({jGFeed:function(e,b,d,f){if(e==null){return false
}var c="http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&callback=?&q="+e;
if(d!=null){c+="&num="+d
}if(f!=null){c+="&key="+f
}a.getJSON(c,function(g){if(typeof b=="function"){b.call(this,g.responseData.feed)
}else{return false
}})
}})
})(jQuery);
var cookieList=function(c){var b=$.cookie(c);
var a=b?b.split(/,/):new Array();
return{add:function(f){var d=this.items();
var e=$.inArray(f,d);
if(e==-1){d.push(f);
$.cookie(c,d.join(","),{expires:365,path:"/"})
}},remove:function(d){indx=$.inArray(d,a);
if(indx!=-1){a.splice(indx,1)
}$.cookie(c,a.join(","),{expires:7,path:"/"})
},clear:function(){a=null;
$.cookie(c,null)
},items:function(){return a
}}
};
var recentlyViewedList=new cookieList("recentlyViewed");
$(document).ready(function(){$(":input[type=number]").on("mousewheel",function(c){$(this).blur()
});
var b=document.referrer;
recentlyViewedList.add(b);
$("#click").click(function(){if(document.documentMode&&document.documentMode<9){var e=Array.prototype.splice;
Array.prototype.splice=function(){var j=[],k=0,h=arguments.length;
for(;
k<h;
k++){j.push(arguments[k])
}if(j.length==1){j.push(this.length-j[0])
...
for(var c=0;
c<g.length;
c++){console.log("inside for loop"+g[c]);
if((jQuery.inArray(g[c],d))==-1){d.push(g[c])
}}for(var c=d.length-1;
c>=d.length-5;
c--){if(d[c]!=undefined){console.log("inside split if ");
if((d[c].split("/")[d[c].split("/").length-1].search("html"))!=-1){var f=(d[c].split("/")[d[c].split("/").length-1]).split(".")[0]
}f=f.replace(/-/g," ").replace(/_/g," ").replace(/\w\S*/g,function(h){return h.charAt(0).toUpperCase()+h.substr(1).toLowerCase()
});
$(".cookie_display").append("<li><a href='"+d[c]+"' title='"+f+"'>"+f+"</a></li>")
}}});
$("#locatelinksul li").click(function(){$("#locatelinksul").find(".active").removeClass("active");
$(this).addClass("active")
});
var a={};
$("input#enteredlocation, input#searchbox, input#enteredlocationBranch").autocomplete({minLength:3,source:function(e,c){var d=e.term;
$.ajax({type:"POST",url:"/bin/getlocations/autocomplete",data:{keywords:d},success:function(f){c(f)
},error:function(f){console.log("location autocomplete error")
}})
}})
});
function scrollPaneAccLoad(){$(".dirIcon").click(function(){$(this).addClass("sel").siblings().removeClass("sel")
});
$(".atmSearchContainer > ul > li").click(function(){var a=$(this).index();
$(this).toggleClass("sel").siblings().removeClass("sel");
$(".refineSearch").eq(a).slideToggle().siblings().hide()
});
$(".swap").click(function(){var b=$(this).parent().find('input[name="From"]').val();
var a=$(this).parent().find('input[name="To"]').val();
$(this).parent().find('input[name="From"]').val(a);
$(this).parent().find('input[name="To"]').val(b)
})
}function parseQueryFromUrl(e){var c=window.location.search.substr(1);
var d=c.split("&");
for(var b=0;
b<d.length;
b++){var a=d[b].split("=");
if(decodeURIComponent(a[0])==e){return decodeURIComponent(a[1].replace(/\+/g," "))
}}return""
}(function(g){var d={init:function(h){return this.each(function(){var o=window.navigator.appVersion.match(/Chrome\/(\d+)\./),p=o?parseInt(o[1],10):false,r=function(y){var i=document.getElementById(y),v=i.parentElement,w=document.createElement("div"),x=document.createDocumentFragment();
v.insertBefore(w,i);
x.appendChild(i);
v.replaceChild(i,w);
x=null;
...
if(g.support.touch){j.isTouch=true;
j.resetDelay=350
}j.container=g(this);
var u=j.container;
j.prefix=f(u[0]);
j.prefix=j.prefix?"-"+j.prefix.toLowerCase()+"-":"";
u.find(j.targetSelector).each(function(){j.origOrder.push(g(this))
});
if(j.sortOnLoad){var s,k;
if(g.isArray(j.sortOnLoad)){s=j.sortOnLoad[0],k=j.sortOnLoad[1];
g(j.sortSelector+"[data-sort="+j.sortOnLoad[0]+"][data-order="+j.sortOnLoad[1]+"]").addClass("active")
}else{g(j.sortSelector+"[data-sort="+j.sortOnLoad+"]").addClass("active");
s=j.sortOnLoad,j.sortOnLoad="desc"
}e(s,k,u,j)
}for(var n=0;
n<2;
n++){var t=n==0?t=j.prefix:"";
...
}if(j.layoutMode=="list"){u.addClass(j.listClass);
j.origDisplay=j.targetDisplayList
}else{u.addClass(j.gridClass);
j.origDisplay=j.targetDisplayGrid
}j.origLayout=j.layoutMode;
var q=j.showOnLoad.split(" ");
g.each(q,function(){g(j.filterSelector+'[data-filter="'+this+'"]').addClass("active")
});
u.find(j.targetSelector).addClass("mix_all");
if(q[0]=="all"){q[0]="mix_all",j.showOnLoad="mix_all"
}var l=g();
g.each(q,function(){l=l.add(g("."+this))
});
l.each(function(){var i=g(this);
if(j.layoutMode=="list"){i.css("display",j.targetDisplayList)
}else{i.css("display",j.targetDisplayGrid)
}i.css(j.transition)
});
var m=setTimeout(function(){j.mixing=true;
l.css("opacity","1");
var i=setTimeout(function(){if(j.layoutMode=="list"){l.removeStyle(j.prefix+"transition, transition").css({display:j.targetDisplayList,opacity:1})
}else{l.removeStyle(j.prefix+"transition, transition").css({display:j.targetDisplayGrid,opacity:1})
}j.mixing=false;
if(typeof j.onMixLoad=="function"){var v=j.onMixLoad.call(this,j);
j=v?v:j
}},j.transitionSpeed)
},10);
j.filter=j.showOnLoad;
g(j.sortSelector).bind(j.buttonEvent,function(){if(!j.mixing){var w=g(this),v=w.attr("data-sort"),i=w.attr("data-order");
if(!w.hasClass("active")){g(j.sortSelector).removeClass("active");
w.addClass("active")
}else{if(v!="random"){return false
}}u.find(j.targetSelector).each(function(){j.startOrder.push(g(this))
});
a(j.filter,v,i,u,j)
}});
g(j.filterSelector).bind(j.buttonEvent,function(){if(!j.mixing){var w=g(this);
if(j.multiFilter==false){g(j.filterSelector).removeClass("active");
w.addClass("active");
j.filter=w.attr("data-filter");
g(j.filterSelector+'[data-filter="'+j.filter+'"]').addClass("active")
}else{var i=w.attr("data-filter");
if(w.hasClass("active")){w.removeClass("active");
var v=new RegExp("(\\s|^)"+i);
j.filter=j.filter.replace(v,"")
}else{w.addClass("active");
j.filter=j.filter+" "+i
}}a(j.filter,null,null,u,j)
}})
})
},toGrid:function(){return this.each(function(){var h=this.config;
if(h.layoutMode!="grid"){h.layoutMode="grid";
a(h.filter,null,null,g(this),h)
}})
},toList:function(){return this.each(function(){var h=this.config;
if(h.layoutMode!="list"){h.layoutMode="list";
a(h.filter,null,null,g(this),h)
}})
},filter:function(h){return this.each(function(){var i=this.config;
if(!i.mixing){g(i.filterSelector).removeClass("active");
g(i.filterSelector+'[data-filter="'+h+'"]').addClass("active");
a(h,null,null,g(this),i)
}})
},sort:function(h){return this.each(function(){var j=this.config,l=g(this);
if(!j.mixing){g(j.sortSelector).removeClass("active");
if(g.isArray(h)){var k=h[0],i=h[1];
g(j.sortSelector+'[data-sort="'+h[0]+'"][data-order="'+h[1]+'"]').addClass("active")
}else{g(j.sortSelector+'[data-sort="'+h+'"]').addClass("active");
var k=h,i="desc"
}l.find(j.targetSelector).each(function(){j.startOrder.push(g(this))
});
a(j.filter,k,i,l,j)
}})
},multimix:function(h){return this.each(function(){var i=this.config,j=g(this);
multiOut={filter:i.filter,sort:null,order:"desc",layoutMode:i.layoutMode};
g.extend(multiOut,h);
if(!i.mixing){g(i.filterSelector).add(i.sortSelector).removeClass("active");
g(i.filterSelector+'[data-filter="'+multiOut.filter+'"]').addClass("active");
if(typeof multiOut.sort!=="undefined"){g(i.sortSelector+'[data-sort="'+multiOut.sort+'"][data-order="'+multiOut.order+'"]').addClass("active");
j.find(i.targetSelector).each(function(){i.startOrder.push(g(this))
})
}i.layoutMode=multiOut.layoutMode;
a(multiOut.filter,multiOut.sort,multiOut.order,j,i)
}})
},remix:function(h){return this.each(function(){var i=this.config,j=g(this);
i.origOrder=[];
j.find(i.targetSelector).each(function(){var k=g(this);
k.addClass("mix_all");
i.origOrder.push(k)
});
if(!i.mixing&&typeof h!=="undefined"){g(i.filterSelector).removeClass("active");
g(i.filterSelector+'[data-filter="'+h+'"]').addClass("active");
a(h,null,null,j,i)
}})
}};
g.fn.mixitup=function(i,h){if(d[i]){return d[i].apply(this,Array.prototype.slice.call(arguments,1))
}else{if(typeof i==="object"||!i){return d.init.apply(this,arguments)
}}};
function a(q,r,u,m,D){clearInterval(D.failsafe);
D.mixing=true;
D.filter=q;
if(typeof D.onMixStart=="function"){var o=D.onMixStart.call(this,D);
D=o?o:D
}var w=D.transitionSpeed;
for(var v=0;
v<2;
v++){var C=v==0?C=D.prefix:"";
...
p.each(function(){this.data={}
});
var A=p.parent();
A.css(D.perspective);
D.easingFallback="ease-in-out";
if(D.easing=="smooth"){D.easing="cubic-bezier(0.25, 0.46, 0.45, 0.94)"
}if(D.easing=="snap"){D.easing="cubic-bezier(0.77, 0, 0.175, 1)"
}if(D.easing=="windback"){D.easing="cubic-bezier(0.175, 0.885, 0.320, 1.275)",D.easingFallback="cubic-bezier(0.175, 0.885, 0.320, 1)"
}if(D.easing=="windup"){D.easing="cubic-bezier(0.6, -0.28, 0.735, 0.045)",D.easingFallback="cubic-bezier(0.6, 0.28, 0.735, 0.045)"
}var k=D.layoutMode=="list"&&D.listEffects!=null?D.listEffects:D.effects;
if(Array.prototype.indexOf){D.fade=k.indexOf("fade")>-1?"0":"";
...
if(typeof q==="string"){s=b(q)
}else{j=true;
g.each(q,function(G){s[G]=b(this)
})
}if(D.filterLogic=="or"){if(s[0]==""){s.shift()
}if(s.length<1){t=t.add(m.find(z+":visible"))
}else{p.each(function(){var G=g(this);
if(!j){if(G.is("."+s.join(", ."))){h=h.add(G)
}else{t=t.add(G)
}}else{var i=0;
g.each(s,function(H){if(this.length){if(G.is("."+this.join(", ."))){i++
}}else{if(i>0){i++
}}});
if(i==s.length){h=h.add(G)
}else{t=t.add(G)
}}})
}}else{h=h.add(A.find(z+"."+s.join(".")));
t=t.add(A.find(z+":not(."+s.join(".")+"):visible"))
}var F=h.length;
var n=g(),y=g(),E=g();
t.each(function(){var i=g(this);
if(i.css("display")!="none"){n=n.add(i);
E=E.add(i)
}});
if(h.filter(":visible").length==F&&!n.length&&!r){if(D.origLayout==D.layoutMode){x();
return false
}else{if(h.length==1){if(D.layoutMode=="list"){m.addClass(D.listClass);
m.removeClass(D.gridClass);
E.css("display",D.targetDisplayList)
}else{m.addClass(D.gridClass);
m.removeClass(D.listClass);
E.css("display",D.targetDisplayGrid)
}x();
return false
}}}D.origHeight=A.height();
if(h.length){m.removeClass(D.failClass);
h.each(function(){var i=g(this);
if(i.css("display")=="none"){y=y.add(i)
}else{E=E.add(i)
}});
if((D.origLayout!=D.layoutMode)&&D.animateGridList==false){if(D.layoutMode=="list"){m.addClass(D.listClass);
m.removeClass(D.gridClass);
E.css("display",D.targetDisplayList)
}else{m.addClass(D.gridClass);
m.removeClass(D.listClass);
...
E.each(function(){this.data.origPos=g(this).offset()
});
if(D.layoutMode=="list"){m.addClass(D.listClass);
m.removeClass(D.gridClass);
y.css("display",D.targetDisplayList)
}else{m.addClass(D.gridClass);
m.removeClass(D.listClass);
y.css("display",D.targetDisplayGrid)
}y.each(function(){this.data.showInterPos=g(this).offset()
});
n.each(function(){this.data.hideInterPos=g(this).offset()
});
E.each(function(){this.data.preInterPos=g(this).offset()
});
if(D.layoutMode=="list"){E.css("display",D.targetDisplayList)
}else{E.css("display",D.targetDisplayGrid)
}if(r){e(r,u,m,D)
}if(r&&c(D.origSort,D.checkSort)){x();
return false
}n.hide();
y.each(function(G){this.data.finalPos=g(this).offset()
});
E.each(function(){this.data.finalPrePos=g(this).offset()
});
D.newHeight=A.height();
if(r){e("reset",null,m,D)
}y.hide();
E.css("display",D.origDisplay);
if(D.origDisplay=="block"){m.addClass(D.listClass);
y.css("display",D.targetDisplayList)
}else{m.removeClass(D.listClass);
y.css("display",D.targetDisplayGrid)
}if(D.resizeContainer){A.css("height",D.origHeight+"px")
}var l={};
for(var v=0;
v<2;
v++){var C=v==0?C=D.prefix:"";
...
E.each(function(){var I=this.data,K=g(this);
if(K.hasClass("mix_tohide")){I.preTX=I.origPos.left-I.hideInterPos.left;
I.preTY=I.origPos.top-I.hideInterPos.top
}else{I.preTX=I.origPos.left-I.preInterPos.left;
I.preTY=I.origPos.top-I.preInterPos.top
}var J={};
for(var H=0;
H<2;
H++){var G=H==0?G=D.prefix:"";
...
E.each(function(){var M=this.data;
...
A.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd",function(i){if(i.originalEvent.propertyName.indexOf("transform")>-1||i.originalEvent.propertyName.indexOf("opacity")>-1){if(z.indexOf(".")>-1){if(g(i.target).hasClass(z.replace(".",""))){x()
}}else{if(g(i.target).is(z)){x()
}}}})
},10);
D.failsafe=setTimeout(function(){if(D.mixing){x()
}},w+400)
}else{if(D.resizeContainer){A.css("height",D.origHeight+"px")
}if(!window.atob){x();
return false
}n=t;
var B=setTimeout(function(){A.css(D.perspective);
if(D.resizeContainer){var K={};
for(var J=0;
J<2;
J++){var H=J==0?H=D.prefix:"";
...
A.bind("webkitTransitionEnd transitionend otransitionend oTransitionEnd",function(i){if(i.originalEvent.propertyName.indexOf("transform")>-1||i.originalEvent.propertyName.indexOf("opacity")>-1){m.addClass(D.failClass);
x()
}})
}else{D.mixing=false
}},10)
}function x(){A.unbind("webkitTransitionEnd transitionend otransitionend oTransitionEnd");
if(r){e(r,u,m,D)
...
if(!window.atob){p.css({display:"none",opacity:"0"})
...
if(D.layoutMode=="list"){h.css({display:D.targetDisplayList,opacity:"1"});
D.origDisplay=D.targetDisplayList
}else{h.css({display:D.targetDisplayGrid,opacity:"1"});
D.origDisplay=D.targetDisplayGrid
}D.origLayout=D.layoutMode;
var G=setTimeout(function(){p.removeStyle(D.prefix+"transition, transition");
D.mixing=false;
if(typeof D.onMixEnd=="function"){var H=D.onMixEnd.call(this,D);
D=H?H:D
}})
}}function e(o,h,n,k){function m(q,p){var s=isNaN(q.attr(o)*1)?q.attr(o).toLowerCase():q.attr(o)*1,r=isNaN(p.attr(o)*1)?p.attr(o).toLowerCase():p.attr(o)*1;
if(s<r){return -1
}if(s>r){return 1
}return 0
}function i(p){if(h=="asc"){j.prepend(p).prepend(" ")
}else{j.append(p).append(" ")
}}function l(v){var r=v.slice();
var q=r.length;
var u=q;
while(u--){var w=parseInt(Math.random()*q);
var s=r[u];
r[u]=r[w];
r[w]=s
}return r
...
if(!k.origSort.length){j.find(k.targetSelector+":visible").each(function(){g(this).wrap("<s/>");
k.origSort.push(g(this).parent().html().replace(/\s+/g,""));
g(this).unwrap()
})
}j.empty();
if(o=="reset"){g.each(k.startOrder,function(){j.append(this).append(" ")
})
}else{if(o=="default"){g.each(k.origOrder,function(){i(this)
})
}else{if(o=="random"){if(!k.newOrder.length){k.newOrder=l(k.startOrder)
}g.each(k.newOrder,function(){j.append(this).append(" ")
})
}else{if(o=="custom"){g.each(h,function(){i(this)
})
}else{if(typeof k.origOrder[0].attr(o)==="undefined"){console.log("No such attribute found. Terminating");
return false
}if(!k.newOrder.length){g.each(k.origOrder,function(){k.newOrder.push(g(this))
});
k.newOrder.sort(m)
}g.each(k.newOrder,function(){i(this)
})
}}}}k.checkSort=[];
j.find(k.targetSelector+":visible").each(function(p){var q=g(this);
if(p==0){q.attr("data-checksum","1")
}q.wrap("<s/>");
k.checkSort.push(q.parent().html().replace(/\s+/g,""));
q.unwrap()
});
n.find(k.targetSelector).unwrap()
}function f(j){var k=["Webkit","Moz","O","ms"];
for(var h=0;
h<k.length;
h++){if(k[h]+"Transition" in j.style){return k[h]
}}return"transition" in j.style?"":false
}g.fn.removeStyle=function(h){return this.each(function(){var j=g(this);
h=h.replace(/\s+/g,"");
var i=h.split(",");
g.each(i,function(){var k=new RegExp(this.toString()+"[^;]+;?","g");
j.attr("style",function(l,m){if(m){return m.replace(k,"")
}})
})
})
};
function c(j,h){if(j.length!=h.length){return false
}for(var k=0;
k<h.length;
k++){if(j[k].compare){if(!j[k].compare(h[k])){return false
}}if(j[k]!==h[k]){return false
}}return true
}function b(i){i=i.replace(/\s{2,}/g," ");
var h=i.split(" ");
g.each(h,function(j){if(this=="all"){h[j]="mix_all"
}});
if(h[0]==""){h.shift()
}return h
}})(jQuery);
function moderateComment(d,g,f){var b=$("#postcommentstoragetitle").val();
var a=$("#currentPagePath").val();
if(d=="edit"){var c=$("#editcommentArea"+f).val()
}if(d=="subedit"){var c=$("#subeditcommentArea"+f).val()
}if(d=="approve"){var e=$("#commentStatus"+f).val();
if(e=="yes"){$("#pwrapper-int-already").show();
$("#alreadyposted").trigger("click");
return false
}}if(d=="subapprove"){var e=$("#subcommentStatus"+f).val();
if(e=="yes"){$("#pwrapper-int-already").show();
$("#alreadyposted").trigger("click");
return false
}}$.ajax({type:"POST",url:"/bin/moderateComment/posteddata",data:{moderateKey:d,moderateNode:g,editedComment:c,pageTitle:b,moderationPagePath:a},success:function(h){location.reload()
},error:function(h){}})
}
...
}}}function x(g){var c,j,i=B.createElement("div"),h=g;
for(c in h){if(j=h[c],"undefined"!=typeof i.style[j]){return i=null,[j,c]
}}return[!1]
...
}},{filter:["items","settings"],run:function(){var g,f,j=this._clones,i=this._items,h=this.settings.loop?j.length-Math.max(2*this.settings.items,4):0;
for(g=0,f=Math.abs(h/2);
f>g;
g++){h>0?(this.$stage.children().eq(i.length+j.length-1).remove(),j.pop(),this.$stage.children().eq(0).remove(),j.pop()):(j.push(j.length/2),this.$stage.append(i[j[j.length-1]].clone().addClass("cloned")),j.push(i.length-1-(j.length-1)/2),this.$stage.prepend(i[j[j.length-1]].clone().addClass("cloned")))
}}},{filter:["width","items","settings"],run:function(){var h,g,l,k=this.settings.rtl?1:-1,j=(this.width()/this.settings.items).toFixed(3),i=0;
for(this._coordinates=[],g=0,l=this._clones.length+this._items.length;
l>g;
g++){h=this._mergers[this.relative(g)],h=this.settings.mergeFit&&Math.min(h,this.settings.items)||h,i+=(this.settings.autoWidth?this._items[this.relative(g)].width()+this.settings.margin:j*h)*k,this._coordinates.push(i)
...
}},{filter:["width","position","items","settings"],run:function(){var G,F,E,o,n=this.settings.rtl?1:-1,m=2*this.settings.stagePadding,l=this.coordinates(this.current())+m,k=l+this.width()*n,j=[];
for(E=0,o=this._coordinates.length;
o>E;
E++){G=this._coordinates[E-1]||0,F=Math.abs(this._coordinates[E])+m*n,(this.op(G,"<=",l)&&this.op(G,">",k)||this.op(F,"<",l)&&this.op(F,">",k))&&j.push(E)
...
},z.prototype.onDragStart=function(j){var f,c,b,a;
if(f=j.originalEvent||j||C.event,3===f.which||this.state.isTouch){return !1
...
},z.prototype.closest=function(a){var j=-1,i=30,h=this.width(),g=this.coordinates();
return this.settings.freeDrag||D.each(g,D.proxy(function(b,c){return a>c-i&&c+i>a?j=b:this.op(a,"<",c)&&this.op(a,">",g[b+1]||c-h)&&(j="left"===this.state.direction?b+1:b),-1===j
},this)),this.settings.loop||(this.op(a,">",g[this.minimum()])?j=a=this.minimum():this.op(a,"<",g[this.maximum()])&&(j=a=this.maximum())),j
},z.prototype.animate=function(a){this.trigger("translate"),this.state.inMotion=this.speed()>0,this.support3d?this.$stage.css({transform:"translate3d("+a+"px,0px, 0px)",transition:this.speed()/1000+"s"}):this.state.isTouch?this.$stage.css({left:a+"px"}):this.$stage.animate({left:a},1000,this.settings.fallbackEasing,D.proxy(function(){this.state.inMotion&&this.transitionEnd()
},this))
...
},z.prototype.maximum=function(h){var g,l,k,j=0,i=this.settings;
if(h){return this._items.length-1
}if(!i.loop&&i.center){g=this._items.length-1
}else{if(i.loop||i.center){if(i.loop||i.center){g=this._items.length+i.items
}else{if(!i.autoWidth&&!i.merge){throw"Can not detect maximum absolute position."
}for(revert=i.rtl?1:-1,l=this.$stage.width()-this.$element.width();
(k=this.coordinates(j))&&!(k*revert>=l);
){g=++j
}}}else{g=this._items.length-i.items
}}return g
...
},z.prototype.to=function(E,o){if(this.settings.loop){var n=E-this.relative(this.current()),m=this.current(),l=this.current(),k=this.current()+n,b=0>l-k?!0:!1,a=this._clones.length+this._items.length;
k<this.settings.items&&b===!1?(m=l+this._items.length,this.reset(m)):k>=a-this.settings.items&&b===!0&&(m=l-this._items.length,this.reset(m)),C.clearTimeout(this.e._goToLoop),this.e._goToLoop=C.setTimeout(D.proxy(function(){this.speed(this.duration(this.current(),m+n,o)),this.current(m+n),this.update()
},this),30)
}else{this.speed(this.duration(this.current(),E,o)),this.current(E),this.update()
...
},z.prototype.preloadAutoWidthImages=function(a){var j,i,h,g;
j=0,i=this,a.each(function(c,b){h=D(b),g=new Image,g.onload=function(){j++,h.attr("src",g.src),h.css("opacity",1),j>=a.length&&(i.state.imagesLoaded=!0,i.initialize())
...
},z.prototype.trigger=function(a,l,k){var j={item:{count:this._items.length,index:this.current()}},i=D.camelCase(D.grep(["on",a,k],function(b){return b
}).join("-").toLowerCase()),h=D.Event([a,"owl",k||"carousel"].join(".").toLowerCase(),D.extend({relatedTarget:this},j,l));
...
}(window.Zepto||window.jQuery,window,document),function(e,d){var f=function(a){this._core=a,this._loaded=[],this._handlers={"initialized.owl.carousel change.owl.carousel":e.proxy(function(i){if(i.namespace&&this._core.settings&&this._core.settings.lazyLoad&&(i.property&&"position"==i.property.name||"initialized"==i.type)){for(var o=this._core.settings,n=o.center&&Math.ceil(o.items/2)||o.items,m=o.center&&-1*n||0,l=(i.property&&i.property.value||this._core.current())+m,k=this._core.clones().length,j=e.proxy(function(g,c){this.load(c)
},this);
m++<n;
...
!a||e.inArray(b.get(0),this._loaded)>-1||(a.each(e.proxy(function(l,k){var j,i=e(k),h=d.devicePixelRatio>1&&i.attr("data-src-retina")||i.attr("data-src");
this._core.trigger("load",{element:i,url:h},"lazy"),i.is("img")?i.one("load.owl.lazy",e.proxy(function(){i.css("opacity",1),this._core.trigger("loaded",{element:i,url:h},"lazy")
},this)).attr("src",h):(j=new Image,j.onload=e.proxy(function(){i.css({"background-image":"url("+h+")",opacity:"1"}),this._core.trigger("loaded",{element:i,url:h},"lazy")
},this),j.src=h)
...
},this),"prepared.owl.carousel":f.proxy(function(d){var i=f(d.content).find(".owl-video");
...
g.Defaults={video:!1,videoHeight:!1,videoWidth:!1},g.prototype.fetch=function(j,i){var o=j.attr("data-vimeo-id")?"vimeo":"youtube",n=j.attr("data-vimeo-id")||j.attr("data-youtube-id"),m=j.attr("data-width")||this._core.settings.videoWidth,l=j.attr("data-height")||this._core.settings.videoHeight,k=j.attr("href");
if(!k){throw new Error("Missing video URL.")
}if(n=k.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/),n[3].indexOf("youtu")>-1){o="youtube"
}else{if(!(n[3].indexOf("vimeo")>-1)){throw new Error("Video URL not supported.")
}o="vimeo"
}n=n[6],this._videos[k]={type:o,id:n,width:m,height:l},i.attr("data-video",k),this.thumbnail(j,this._videos[k])
...
return v.wrap('<div class="owl-video-wrapper"'+q+"></div>"),this._core.settings.lazyLoad&&(o="data-src",n="owl-lazy"),p.length?(a(p.attr(o)),p.remove(),!1):void ("youtube"===u.type?(r="http://img.youtube.com/vi/"+u.id+"/hqdefault.jpg",a(r)):"vimeo"===u.type&&f.ajax({type:"GET",url:"http://vimeo.com/api/v2/video/"+u.id+".json",jsonp:"callback",dataType:"jsonp",success:function(b){r=b[0].thumbnail_large,a(r)
}}))
...
var p,o,n=f(a.target||a.srcElement),m=n.closest("."+this._core.settings.itemClass),l=this._videos[m.attr("data-video")],k=l.width||"100%",j=l.height||this._core.$stage.height();
...
}(window.Zepto||window.jQuery,window,document),function(g,f,j,i){var h=function(a){this.core=a,this.core.options=g.extend({},h.Defaults,this.core.options),this.swapping=!0,this.previous=i,this.next=i,this.handlers={"change.owl.carousel":g.proxy(function(b){"position"==b.property.name&&(this.previous=this.core.current(),this.next=b.property.value)
...
},this),"play.owl.autoplay":f.proxy(function(i,d,j){this.play(d,j)
...
}},c.prototype.update=function(){var i,h,n,m=this._core.settings,l=this._core.clones().length/2,k=l+this._core.items().length,j=m.center||m.autoWidth||m.dotData?1:m.dotsEach||m.items;
if("page"!==m.slideBy&&(m.slideBy=Math.min(m.slideBy,m.items)),m.dots||"page"==m.slideBy){for(this._pages=[],i=l,h=0,n=0;
k>i;
i++){(h>=j||0===h)&&(this._pages.push({start:i-l,end:i-l+j-1}),h=0,++n),h+=this._core.mergers(this._core.relative(i))
}}},c.prototype.draw=function(){var a,j,i="",h=this._core.settings,g=(this._core.$stage.children(),this._core.relative(this._core.current()));
if(!h.nav||h.loop||h.navRewind||(this._controls.$previous.toggleClass("disabled",0>=g),this._controls.$next.toggleClass("disabled",g>=this._core.maximum())),this._controls.$previous.toggle(h.nav),this._controls.$next.toggle(h.nav),h.dots){if(a=this._pages.length-this._controls.$indicators.children().length,h.dotData&&0!==a){for(j=0;
j<this._controls.$indicators.children().length;
j++){i+=this._templates[this._core.relative(j)]
}this._controls.$indicators.html(i)
}else{a>0?(i=new Array(a+1).join(this._templates[0]),this._controls.$indicators.append(i)):0>a&&this._controls.$indicators.children().slice(a).remove()
