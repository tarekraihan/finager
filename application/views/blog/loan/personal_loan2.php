		...
		<div class="container">
			<div class="details_post">
				<div class="details_heading">
					<h3>How to Get an Unsecured Personal Loan</h3>
				...
				<b>What you need to apply for a personal loan</b>
				<p>
					To apply for a personal loan, here are the documents you’ll typically need to provide:
					<ul style="margin-left:15px;">
						<li>Identification – passport, driver’s license, state ID or Social Security card</li>
						<li>Verification of address – utility bills, recent mail or copy of lease</li>
						<li>Proof of past income – W-2 forms, pay stubs, bank statements or tax returns</li>
					</ul><br/>
					You may also be asked for this information:
					<ul style="margin-left:15px;">
						<li>Social Security number</li>
						<li>Monthly debt obligations (rent, student loans, etc.)</li>
						<li>Gross income</li>
						<li>Employer’s name, work address and phone number</li>
						<li>Address, email, phone number</li>
						<li>Previous addresses</li>
						<li>Date of birth</li>
						<li>Mother’s maiden name</li>
						<li>College name and major</li>
					</ul>
				</p>
				<br/>
				<p>
					After providing this information, you’ll need to specify the amount of money you want to borrow and some lenders
					may ask you to choose how much time you need to repay it (typically two to five years). Keep in mind that the longer
					you pay back your loan, the more you’ll have to shell out for interest payments. If you borrow only what you need, you can keep your costs low.
				</p>
			</div>
		</div>	
	</section>	
