		...
		<div class="container">
			<div class="details_post">
				<div class="details_heading">
					<h3>What is Deposit Accounts?</h3>
				...
				<br/>
				<h4><b>We’re Unbiased</b></h4>
				<p>
					We are the first major bank account comparison site that's truly unbiased. While other sites omit or hide the best rates available in order to promote their advertisers,
					advertising relationships never affect which rates we include in our tables. We receive no compensation for over 99% of the banks and credit unions we list. While 
					this approach doesn't produce the most short-term revenue, we're confident that putting the user first will help us become the go-to site in the long run.
				</p>
				<br/>
				<h4><b>We’re Comprehensive</b></h4>
				<p>
					We have been covering current deals and saving strategies for more than ten years. To date we have published more than 11,000 articles highlighting current banking
					deals, providing expert depository market and product analyses, and detailing savings strategies and techniques. We provide extensive financial and product information 
					on the approximately 14,000 banks and credit unions we cover. Our coverage includes a proprietary institution health rating algorithm that has been recognized and
					cited in hundreds of media outlets. And perhaps above all, we are blessed to have the active participation of one of the largest communities of savers on the 
					Web – our users have contributed more than 100,000 comments, forum posts, and bank reviews….and counting!
				</p>
				<br/>
				<h4><b>We Have the Best Rates</b></h4>
				<p>
					Our unbiased nature and massive database of proprietary rate data allows us to provide you with better and more accurate rates and more options than any of our 
					competitors. We don't just track the national banks; we also track the regional and local banks and credit unions that often have the best deals. In total, we track 
					and display almost 300,000 rates from U.S. banks and credit unions, which enables us to provide you with the best deposit rates and deals to be found on the Web. 
					But don't just take our word for it! Please go check for yourself at any of our competitors’ sites listed below.
				</p>
			</div>
		</div>	
	</section>	
