		...
		<div class="container">
			<div class="details_post">
				<div class="details_heading">
					<h3>The DPS Insured Scheme</h3>
					<h4><i>Asef Jamil, 02-Oct-2016</i></h4>
				</div><br/>
				<h4><b>Insured deposit protection from The DPS</b></h4>
				<p>
				...
				<h4><b>About The DPS Insured Scheme</b></h4>
				<p>
					...
					Deposit Protection (TDP) scheme and that, subject to the conclusion of formalities, will be offering an ‘insured’ version of their highly acclaimed and award winning 
					‘custodial’ scheme, with effect from 1st April 2013.
				</p><br/>
				<p>
					<ul style="margin-left:15px;">
						<li>No registration or annual renewal fees</li>
						<li>You retain the deposit and protection will be provided to your tenant for the duration of the tenancy</li>
						<li>Available to landlords on a 'pay as you go', per tenancy basis</li>
						<li>Letting agents will be required to be associated with, members of or accredited by RICS, ARLA, NAEA, NALS, UKALA or The Law Society</li>
						<li>Subject to volumes, fee payment of monthly accounts in arrears by variable direct debit will be available for letting agents</li>
						<li>Indemnity will be provided to the tenant for the duration of the tenancy</li>
						<li>Competitively priced</li>
						<li>Letting agents will be required to be associated with, members of or accredited by RICS, ARLA, NAEA, NALS, UKALA or The Law Society and will be required to agree to monthly invoicing paid by direct debit</li>
						<li>Volume discounts may be available for letting agents – please contact us for further details</li>
					</ul>
				</p>
			</div>
		</div>	
