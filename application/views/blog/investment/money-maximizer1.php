		...
		<div class="container">
			<div class="details_post">
				<div class="details_heading">
					<h3>Money Multiplier Plan</h3>
					<h4><i>Asef Jamil, 02-Oct-2016</i></h4>
				</div><br/>
				<h4><b>Let Your Money Multiply</b></h4>
				<p>
				...
				<p>
					...
					the ICICI Bank Branch, ICICI Bank Phone Banking and ICICI Bank's Internet Banking for creation of Fixed Deposit(s) from the surplus funds in your Savings Bank Account 
					(subject to a minimum of Rs. 10,000). The Fixed Deposits will be created in multiples of Rs. 5,000 for a tenure of one year or more as instructed by you.
				</p>
				<br/>
				<h4><b>Maximum Liquidity</b></h4>
				<p>
					You can withdraw the funds from your savings account through any channel such as the ICICI Bank ATM, ICICI Bank Internet Banking or by issuing a cheque. etc. 
					All linked Fixed Deposits will be enabled for automatic Reverse Sweep in multiples of Rs. 5000 on a Last-In-First-Out (LIFO) basis when the balance in the Savings 
					Account falls below Rs.10,000. The amount reverse swept will earn interest rates at the applicable rate for the period that the deposit was held with the Bank. The 
					remaining amount will continue to earn higher interest at the original rate applicable to the fixed deposit.
				</p>
				<br/>
