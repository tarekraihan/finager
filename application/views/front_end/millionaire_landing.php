			...
			<div class="biggest_pr">
				...
				<div class="col-md-6 col-sm-6">
					<div class="fdr_bigest_text">
						...
						<a class="land_modal" data-toggle="modal" data-target=".bs-example-modal-lg"><span class="btn_landing_view2_millionaire">View Our Calculators</span>
					</div>
				</div>
			</div>
		</div>
    ...
    <section id="Basic">
        <div class="container">
            ...
            <div class="card_basic row">
                ...
                <div class="col-md-6 col-sm-6">
                    <h4><strong>What is the minimum eligibility for investing in Lakhpoti & Millionaire scheme?</strong></h4>
