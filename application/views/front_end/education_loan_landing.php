			...
			<div class="Sponsored_box">
				<div class="col-md-3 col-sm-6">
					<div class="Sponsored_box1">
						...
						<div class="spnrs1"><img class="img-responsive" src="<?php echo base_url();?>resource/front_end/images/education_text-bg.png" alt="text-bg"/></div>
						<p class="edu_spnrs">Topic Heading</p>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
						</p>
						<button class="btn btn-primary btn-lg edu_btn">Go to slide</button>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="Sponsored_box1">
			...
			<div class="heading_pr">
				<div class="col-md-3 col-sm-6">
					<div class="heading_text">
						...
						<p class="edu_H_loan">Home Loan</p>
						<h4>Heading / Title</h4>
						...
						<div class="edu_home_read"><a href="#">Read More</a></div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="heading_text">
