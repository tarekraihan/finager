        ...
        <div class="row">
                ...
                <div class="home_loan_left_bar">
                    ...
                    <div class="card_query">
                        ...
                        <div class="query_radio">
                            <?php
                            $card_user = $this->Select_model->select_all('personal_loan_looking_for','ASC');
                    ...
                    <div class="card_query">
                        ...
                        <div class="query_radio">
                            <?php
                            $card_user = $this->Select_model->select_all('personal_loan_i_am','ASC');
                            foreach($card_user->result() as $row){
                                ?>
                                <label class="material_radio_group">
            ...
            <div class="col-sm-9 col-xs-9">
                <div id="searchHomeLoan">
                    <?php
                    $home_loan = $this->Front_end_select_model->select_personal_loan_info();
                    $home = '';
                    foreach($home_loan->result() as $row){
                       ...
                       <div class="row home_loan_right_bar no-margin-lr2">
                           <div class="col-sm-3 col-xs-3">
                               ...
                               <small class="home_loan_bank_name">'.$row->personal_loan_looking_for.'</small>
                           </div>
                           <div class="col-sm-9 col-xs-9">
                               <div class="row">
