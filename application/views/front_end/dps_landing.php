...
<section id="Sponsored">
	...
	<div class="container">
		...
		<h2>Finager Always get it right</h2>
			...
			<a class="start_compare" href="javascript:void(0);"><span class="btn_landing_dps_start">Get Started</span></a>
		</div>
	</div>
	</section>
        ...
        <div class="container">
            ...
            <div class="card_basic row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <p>A user can deposit his money 20 year.
                    </p>
                    <hr/>
                </div>
                <div class="col-md-6 col-sm-6">
                ...
                <div class="col-md-6 col-sm-6">
                    <h4><strong>What is the minimum eligibility for opening DPS scheme?</strong></h4>
