...
if(isset($_GET['fees_id']))
{
    ...
    $delete_date = array(
        ...
        "delete_details" => "Delete credit card fees & charges items ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Home</li><li>Card</li><li>Card Fees and Charges List</li>
        </ol>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Supplementary Card</th>
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Late Payment Fee</th>
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Card Replacement Fee</th>
                                    ...
                                    <?php
                                    echo $this->Select_model->select_card_fees_charges_list();
                                    ?>
                                    </tbody>
                                </table>
