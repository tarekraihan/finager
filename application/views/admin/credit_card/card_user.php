...
if(isset($_GET['c_user_id']))
{
    ...
    $delete_date = array(
        ...
        "delete_details" => "Delete credit card user items ",
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>card/card_user" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="text" name="txtCardUser" placeholder="Card User" value ="<?php echo set_value('txtCardUser'); ?>" />
