...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Home</li><li>Card</li><li>Edit Card Issuer</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a href="<?php echo base_url();?>card/card_issuer/" class="btn btn-primary pull-right">Add +</a>
            </div>
        </div>
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="edit_card_issuer" method="post" action="<?php echo base_url();?>card/edit_card_issuer" class="smart-form" novalidate="novalidate">
                                    <?php
