...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Account</li><li>Saving Account</li><li> Add Account Information</li>
    </ol>
</div>
<!-- END RIBBON -->
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <form id="age_limit" method="post" action="<?php echo base_url();?>saving_account/account_info" class="smart-form" novalidate="novalidate">
                    <?php
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="100" name="txtMinAmountInterest" id="txtMinAmountInterest" value="<?php echo set_value('txtMinAmountInterest'); ?>" placeholder="Write  Minimum Account for Interest">
                                    </label>
