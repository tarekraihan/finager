...
if(isset($_GET['looking_id']))
{
    ...
    $delete_date = array(
        ...
        "delete_details" => "Delete debit card looking for items ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Card</li><li>Debit Card</li><li> Looking For</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form  method="post" action="<?php echo base_url();?>debit_card/looking_for" class="smart-form" novalidate="novalidate">
                                    <?php
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Debit Card Looking For </th>
