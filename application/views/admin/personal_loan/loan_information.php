                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>personal_loan/loan_info" class="smart-form" novalidate="novalidate">
                                    <?php
                                        ...
                                        <section>
                                                ...
                                                <section class="col col-6">
                                                    ...
                                                    <label class="select">
                                                        <select multiple style="width:100%" class="select2" name="txtPersonalLoanUser[]" required>
                                                            <?php echo $this->Select_model->personal_loan_user();?>
                                                        </select>
                                                    </label>
                                            ...
                                            <div class="row">
                                                <section class="col col-6"  >
                                                    ...
                                                    <label class="input">
                                                        <input type="number"  name="txtMinimumLoanPeriod" value="<?php echo set_value('txtMinimumLoanPeriod'); ?>" placeholder="Write Minimum Loan Period">
                                                    </label>
                                                ...
                                                <section class="col col-6"  >
                                                    ...
                                                    <label class="input">
                                                        <input type="number"  name="txtMaximumLoanPeriod" value="<?php echo set_value('txtMaximumLoanPeriod'); ?>" placeholder="Write Maximum Loan Period">
                                                    </label>
