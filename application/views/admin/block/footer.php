...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // custom toolbar
        $("div.toolbar").html('<div class="text-right"><img src="<?php echo base_url();?>resource/admin/img/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
