...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Account</li><li>Current Account</li><li>Account List</li>
        </ol>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i>Total Branch</th>
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i>Overdraft Facility</th>
                                    ...
                                    <?php
                                        echo $this->Select_model->get_current_account_info();
                                    ?>
                                    </tbody>
                                </table>
