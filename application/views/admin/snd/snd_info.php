...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Account</li><li>SND Account</li><li> Add Account Information</li>
    </ol>
</div>
<!-- END RIBBON -->
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <form id="age_limit" method="post" action="<?php echo base_url();?>snd/account_info" class="smart-form" novalidate="novalidate">
                    <?php
                        ...
                        <section>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="255" name="txtSavingAccountName" value="<?php echo set_value('txtSavingAccountName'); ?>" placeholder="Write Saving Account Name">
                                    </label>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="100" name="txtNoticeDay" id="txtNoticeDay" value="<?php echo set_value('txtNoticeDay'); ?>" placeholder="Write  Notice Day">
                                    </label>
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                <section class="col col-12">
                    ...
                    <label class="input">
                        <textarea type="text" id="txtAvailableOffer" class="ckeditor" name="txtAvailableOffer"><?php echo set_value('txtAvailableOffer'); ?></textarea>
                    </label>
                </section>
