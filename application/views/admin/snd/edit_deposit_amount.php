...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Accounts</li><li>SND Account</li><li>Update Deposit Amount</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a href="<?php echo base_url();?>snd_account/deposit_amount/" class="btn btn-primary pull-right">Add +</a>
            </div>
                ...
                <article class="col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        <header>
                            ...
                            <h2>Update Deposit Amount Range</h2>
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>snd_account/edit_deposit_amount" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="hidden" name="txtDepositAmountId" value ="<?php echo $row['id']; ?>" />
                                                <input type="text" name="txtDepositAmount" placeholder="Write Deposit Amount" value ="<?php echo $row['deposit_amount_range']; ?>" />
