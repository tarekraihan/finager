...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>General</li><li>Meta</li><li> Meta Tags and Description List</li>
        </ol>
    </div>
    <!-- END RIBBON -->
    <!-- MAIN CONTENT -->
                ...
                <article class="col-md-12">
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                        <header>
                            ...
                            <h2>Meta Tags and Description </h2>
                                ...
                                <div class="table-responsive">
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover " width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i>Product Name</th>
                                            <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Slug </th>
                                            <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Meta Tags </th>
                                            <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Meta Description </th>
