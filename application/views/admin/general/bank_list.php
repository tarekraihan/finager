...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>General</li><li>Bank</li><li> Bank List</li>
        </ol>
    </div>
    <!-- END RIBBON -->
    <!-- MAIN CONTENT -->
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <div class="table-responsive">
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover " width="100%">
                                        ...
                                        <?php
                                        $query = $this->Select_model->select_all_bank_list();
                                        $sl=1;
                                        foreach ($query->result() as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>general/update_bank_non_bank_info/?id=<?php echo $row->id;?>&non_bank=0" class="edit"><i class="fa fa-pencil-square-o fa-lg"></i></a><a href="" onclick="return confirm('Delete Action off for security reason.')" class="delete"> <i class="fa fa-trash-o fa-lg"></i></a></td>
                                            </tr>
                                            <?php
                                            $sl++;
                                        }
