...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Deposit</li><li>Deposit Type</li><li>Update </li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a href="<?php echo base_url();?>fdr/deposit_type/" class="btn btn-primary pull-right">Add +</a>
            </div>
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>fdr/edit_deposit_type" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="hidden" name="txtDepositTypeId" value ="<?php echo $row['id']; ?>" />
                                                <input type="text" name="txtDepositType" placeholder="Write Deposit Type" value ="<?php echo $row['deposit_name']; ?>" />
