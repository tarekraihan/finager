...
if(isset($_GET['feature_id']))
{
    ...
    $row=$this->Select_model->Select_Single_Row($id,$table,$id_field);
        ...
        $delete_date = array(
            ...
            "delete_details" => "Delete home loan feature items ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Loan</li><li>Home Loan</li><li> Features</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>home_loan/feature" class="smart-form" novalidate="novalidate">
                                    <?php
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Loan Features </th>
