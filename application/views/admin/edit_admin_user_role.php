...
if(isset($_GET['a_user_id']))
{
    ...
    $delete_date = array(
        "module_name" => "Admin User role",
        "delete_details" => "Delete admin user role items ",
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>backdoor/edit_admin_role" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="hidden" name="txtAdminRoleId"  value ="<?php echo $row['id']; ?>" />
                                                <input type="text" name="txtAdminRole" placeholder="Admin Role" value ="<?php echo $row['admin_role']; ?>" />
