...
if(isset($_GET['info_id']))
{
    ...
    $delete_date = array(
        ...
        "delete_details" => "Delete millionaire info items ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Deposit</li><li>Millionaire</li><li>Information List</li>
        </ol>
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <?php
                                        echo $this->Select_model->get_millionaire_info();
                                    ?>
                                    </tbody>
                                </table>
