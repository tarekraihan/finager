...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Deposit</li><li>Millionaire</li><li> Maturity Amount</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form  method="post" action="<?php echo base_url();?>millionaire/maturity_amount/" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="text" name="txtMaturityAmount" placeholder="Write Maturity Amount" value ="<?php echo set_value('txtMaturityAmount') ;?>" />
                                            </label>
