...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Deposit</li><li>Millionaire</li><li> Draft/Common Information</li>
        </ol>
    </div>
    <!-- END RIBBON -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>millionaire/draft_info" class="smart-form" novalidate="novalidate">
                                    <?php
