...
if(isset($_GET['tenure_id']))
{
    ...
    $delete_date = array(
        ...
        "delete_details" => "Delete millionaire tenure items ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Deposit</li><li>Millionaire</li><li>Tenure </li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a href="<?php echo base_url();?>millionaire/tenure/" class="btn btn-primary pull-right">Add +</a>
            </div>
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>millionaire/edit_tenure" class="smart-form" novalidate="novalidate">
                                    <?php
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Millionaire Tenure</th>
                                    ...
                                    foreach ($query->result() as $row)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>millionaire/edit_tenure?id=<?php echo $row->id;?>" class="edit"><i class="fa fa-pencil-square-o fa-lg"></i></a><a href="?tenure_id=<?php echo $row->id;?>" onclick="return confirm('Are you really want to delete this item')" class="delete"> <i class="fa fa-trash-o fa-lg"></i></a></td>
                                        </tr>
                                        <?php
                                        $sl++;
                                    }
