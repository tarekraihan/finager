...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Deposit</li><li>Monthly Benefit</li><li> Add Deposit Information</li>
    </ol>
</div>
<!-- END RIBBON -->
    ...
    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
        ...
        <div>
            ...
            <div class="widget-body no-padding">
                ...
                <form id="age_limit" method="post" action="<?php echo base_url();?>monthly_benefit/add_deposit_info" class="smart-form" novalidate="novalidate">
                    <?php
                        ...
                        <section>
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="select">
                                        <select name="txtTenure" id="txtTenure">
                                            <?php echo $this->Select_model->select_monthly_benefit_tenure();?>
                                        </select>
                                    </label>
                            ...
                            <div class="row">
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="250" name="txtDepositName" value="<?php echo set_value('txtDepositName'); ?>" placeholder="Write Deposit Name">
                                    </label>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="20" name="txtDepositAmount" value="<?php echo set_value('txtDepositAmount'); ?>" placeholder="Write Deposit Amount">
                                    </label>
                                ...
                                <section class="col col-6">
                                    <label class="label">Benefit Amount</label>
                                    <label class="input">
                                        <input type="text" maxlength="20" name="txtBenefitAmount" value="<?php echo set_value('txtBenefitAmount'); ?>" placeholder="Write Benefit Amount">
                                    </label>

                                    <label class="red"><?php echo form_error('txtBenefitAmount');?></label>
                                </section>
                            </div>
                            ...
                            <div class="row">
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="20" name="txtMinimumAmount" value="<?php echo set_value('txtMinimumAmount'); ?>" placeholder="Write Minimum Amount">
                                    </label>
                                ...
                                <section class="col col-6">
                                    ...
                                    <label class="input">
                                        <input type="text" maxlength="20" name="txtMaximumAmount" value="<?php echo set_value('txtMaximumAmount'); ?>" placeholder="Write Maximum Amount">
                                    </label>
