...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Loan</li><li>Auto Loan</li><li> Features</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>auto_loan/feature" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="text" name="txtFeature" placeholder="Write Loan Feature" value ="<?php echo set_value('txtFeature') ;?>" />
