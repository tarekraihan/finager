<?php
    ...
    if(isset($_GET['applicant_id']))
    {
        ...
        $delete_date = array(
            ...
            "delete_details" => "Delete auto loan applicant type name ",
...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li>Loan</li><li>Auto Loan</li><li>Update Applicant Type</li>
        </ol>
        <!-- end breadcrumb -->
    </div>
    <!-- END RIBBON -->
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a href="<?php echo base_url();?>auto_loan/applicant_type/" class="btn btn-primary pull-right">Add +</a>
            </div>
                    ...
                    <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <form id="age_limit" method="post" action="<?php echo base_url();?>auto_loan/edit_applicant_type" class="smart-form" novalidate="novalidate">
                                    <?php
                                    ...
                                    <fieldset>
                                        <section>
                                            ...
                                            <label class="input">
                                                <input type="hidden" name="txtAutoLoanApplicantId" value ="<?php echo $row['id']; ?>" />
                                                <input type="text" name="txtAutoLoanApplicant" placeholder="Applicant Type" value ="<?php echo $row['applicant']; ?>" />
                                        ...
                                        <section>
                                            ...
                                            <label class="input">
                                                ...
                                                <input type="text" name="txtRemarks" placeholder="Remarks" value ="<?php echo $row['remarks']; ?>" />
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Applicant Type </th>
