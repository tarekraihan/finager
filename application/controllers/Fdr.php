						...
						<div class="row fdr_right_bar no-margin-lr">
							...
							<div class="col-sm-10 col-xs-10">
								...
								<div class="row more_availabe">
									<div class="col-md-2"><a id="more_info"  class="more_info" href="javascript:void(0)" data-toggle="collapse" data-fdr_id="'.$row->id.'"><i class="fa fa-info-circle" aria-hidden="true" ></i> More Info</a></div>
