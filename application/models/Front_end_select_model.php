...
INNER JOIN card_card_issuer ON card_card_issuer.id=card_card_informations.cc_issuer_id LEFT JOIN card_fees_charges ON card_fees_charges.card_id = card_card_informations.id';*/
        ...
        $query = $this->db->query("SELECT card_card_informations.*,card_bank.bank_name,card_card_type.card_type_name,card_credit_card_type.cc_card_type,card_card_issuer.card_issuer_name,card_fees_charges.`card_id`,
...
FROM card_card_informations LEFT JOIN card_bank ON card_bank.id=card_card_informations.bank_id LEFT JOIN card_card_type ON card_card_type.id=card_card_informations.cc_type_id LEFT JOIN
 card_credit_card_type ON card_credit_card_type.id=card_card_informations.card_category
LEFT JOIN card_card_issuer ON card_card_issuer.id=card_card_informations.cc_issuer_id LEFT JOIN card_fees_charges ON card_fees_charges.card_id = card_card_informations.id");
