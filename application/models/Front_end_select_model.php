...
class Front_end_select_model extends CI_Model{
    ...
    public function select_card_info($query){
        ...
        $sql="SELECT card_card_informations.*,card_bank.bank_name,card_card_type.card_type_name,card_credit_card_type.cc_card_type,card_card_issuer.card_issuer_name,card_fees_charges.`card_id`,
